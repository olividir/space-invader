...
class GameWidget(Widget):
    def __init__(self, **kwargs):
        ...
        with self.canvas:
            ...
            self._score_instruction = Rectangle(texture=self._score_label.texture, pos=(0, Window.height - 50), size=(self._score_label.texture.size))
        ...
        self.sound = SoundLoader.load('Cats_Searching_for_the_Truth.mp3')
        self.sound.play()
...
class Bullet(Entity):
    def __init__(self, pos, speed=300):
        super().__init__()
        sound = SoundLoader.load('shot.mp3')
        sound.play()
        self._speed = speed
        self.pos = pos
...
class Explosion(Entity):
    def __init__(self, pos):
        super().__init__()
        self.pos = pos
        sound = SoundLoader.load('Explosion+1.mp3')
        self.source = '2-26104_explosiion.png'
        sound.play()
